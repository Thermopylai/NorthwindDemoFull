...
namespace Harjoitus_4_1_1.ViewModels
{
    public class CustomersViewModel
    {
        ...
        public IList<CustomerOrderedProduct> CustomerOrderedProducts { get; set; } = new List<CustomerOrderedProduct>();

        public IList<CustomerOrderedProduct> Calculate() 
        {
            foreach (var detail in OrderDetails)
            {
                ...
                {
                    var existingItem = CustomerOrderedProducts.FirstOrDefault(cop => cop.ProductID == detailProduct.ProductID);
                    ...
                    {
                        CustomerOrderedProducts.Add(new CustomerOrderedProduct
                        {
            ...
            CustomerOrderedProducts = CustomerOrderedProducts.OrderBy(cop => cop.ProductID).ToList();
            return CustomerOrderedProducts;
        }
                
        [Display(Name = "Demographics")]
        public IList<CustomerDemographic> CustomerDemographics { get; set; } = new List<CustomerDemographic>();
        public int CustomerDemographicsCount => CustomerDemographics?.Count ?? 0;
